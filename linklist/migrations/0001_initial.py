...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('linklist_link', (
            ...
            ('url', self.gf('django.db.models.fields.URLField')(max_length=50)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='link_images', to=orm['filer.Image'])),
            ...
            ('order', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
